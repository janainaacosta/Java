...
public class Alterar extends javax.swing.JFrame {
    ...
    // variaveis de acesso global para serem acessados por "ActionPerfomed" (nao podem receber parametro)
    // n = novo 
    public String nCPF;
    public String nNome;
    public String nSexo;
    ...
    public void pegarDados(
            //parametros recebidos pela funcao "alterar" da classe "Clientes"
            String CPF,
            String nome,
            String logradouro,
            String numero,
    ...
    public void enviar() {
        ...
        /*
        envia os dados exibidos na tabela para serem alterados
        neste arquivo para o arquivo cliente
         */
        tabela.inserirDados(nNome, nCPF, nEndereco, nTelefone,
                nEmail, nSexo, nEstadoCivil, nDataNasc);

        //abre a tabela atualizada 
    ...
    private void btnConfirmar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmar1ActionPerformed
        ...
        //armazena os dados digitados nos inputs nessas variaveis
        ...
        // valor do comboBox UF guardado em uma variavel
        Object UfSelecionado = slcUf.getSelectedItem();
        if (UfSelecionado == null || UfSelecionado.toString()
                .equals("Selecione...")) {
            ...
            UFDigitado = UfSelecionado.toString();
        }
        ...
        //define os valores inseridos nas variaveis globais
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        ...
        if (selectedItemSexo == null || selectedItemSexo.toString()
                .equals("Selecione...")) {
            JOptionPane.showMessageDialog(null,
    ...
    private void btnConfirmar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmar2ActionPerformed
        ...
        if (emailDigitado.isEmpty()) {
            ...
            // ativa a funcao "enviar"
            enviar();

            // fecha a janela "Alterar"
            this.dispose();
        }
