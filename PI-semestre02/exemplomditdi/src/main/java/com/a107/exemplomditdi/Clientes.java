...
public class Clientes extends javax.swing.JFrame {
    ...
    public void inserirDados(String nome, String CPF, String endereco,
            String telefone, String email, String sexo,
            String estadoCivil, String dataNasc) {
    ...
    public void teste(String znome, String zCPF, String zsexo, String zcivil, String zdata) {
        // Limpar a tabela
        DefaultTableModel model = (DefaultTableModel) tblClientes.getModel();
        model.setRowCount(1);

        // Adicionar os dados atualizados à tabela
        Object[] rowData = {zCPF, znome, zsexo, zcivil, zdata};
        model.addRow(rowData);
    }
    ...
    public void alterar() {
        ...
        if (linhaSelecionada != -1) {
            ...
            this.dispose();
            //alterarCliente.pegarDados(CPF,nome,sexo,estadoCivil,dataNasc,logradouro,numero,bairro,cidade,UF,CEP,telefone,email);
        } else {
